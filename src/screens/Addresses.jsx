        ...
        <div className="px-5 mt-4 pb-6 space-y-3">
          {addresses.map((a) => {
            ...
            return (
              ...
              <div key={a.id} onClick={() => !a.is_default && makeDefaultAddress(a.id)} className={`rounded-2xl shadow-card p-4 transition bg-white ${a.is_default ? "ring-1 ring-brand-500 cursor-default" : "cursor-pointer hover:ring-1 hover:ring-slate-200"}`}>
