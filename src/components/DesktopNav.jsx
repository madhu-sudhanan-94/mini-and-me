...
export default function DesktopNav() {
  ...
  return (
    <header className="hidden lg:block sticky top-[-1px] z-30 bg-white/95 backdrop-blur-sm border-b border-slate-100">
      <div className="max-w-6xl mx-auto w-full px-6 py-3 flex items-center gap-5">
